...
<div class="content-wrapper">
    ...
    <section class="invoice">
        ...
        <div class="row invoice-info">
            ...
            <br>
            <b>Emitido em:</b> <?php echo dateFormat($order["dtregister"]); ?><br>
            <b>Pago em:</b> <?php echo dateFormat($order["dtregister"]); ?>
            </div>
            <!-- /.col -->
        </div>
        <!-- /.row -->
