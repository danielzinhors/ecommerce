        ...
        <form role="form" action="/admin/users/<?php echo htmlspecialchars( $user["iduser"], ENT_COMPAT, 'UTF-8', FALSE ); ?>" method="post" enctype="multipart/form-data">
          <div class="box-body">
            ...
            <div class="form-group">
              ...
              <input type="file" class="form-control" id="foto" name="foto" value="<?php echo htmlspecialchars( $user["foto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
              <div class="box box-widget">
                <div class="box-body">
                  <img class="img-responsive" id="image-preview" alt="Foto" src="<?php echo htmlspecialchars( $user["foto"], ENT_COMPAT, 'UTF-8', FALSE ); ?>">
                </div>
            </div>
          </div>
          <!-- /.box-body -->
