...
<head>
  ...
  <title><?php echo getFieldCompany("nome_fantasia"); ?> | Admin</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="/admin/" class="logo">
      ...
      <span class="logo-lg"><b><?php echo getFieldCompany("nome_fantasia"); ?></b></span>
    </a>
        ...
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            ...
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              ...
              <img src="<?php echo getUserField("foto"); ?>" class="user-image" alt="User Image">
              <!-- hidden-xs hides the username on small devices so only the image appears. -->
              <span class="hidden-xs"><?php echo getUserField("desperson"); ?></span>
            </a>
            <ul class="dropdown-menu">
              <!-- The user image in the menu -->
              <li class="user-header">
                <img src="<?php echo getUserField("foto"); ?>" class="img-circle" alt="User Image">

                <p>
                    <?php echo getUserField("desperson"); ?>

                  <small>Membro desde <?php echo dateFormat(getUserField("dtregister")); ?></small>
                </p>
              </li>
              <!-- Menu Body -->
              <!-- <li class="user-body">
              ...
              <li class="user-footer">
                <div class="pull-left">
                  <a href="/admin/users/<?php echo getUserField("iduser"); ?>" class="btn btn-default btn-flat">Profile</a>
                </div>
    ...
    <section class="sidebar">
      ...
      <div class="user-panel">
        ...
        <div class="pull-left info">
          <p><?php echo getUserField("desperson"); ?></p>
          <!-- Status -->
      ...
      <ul class="sidebar-menu">
        ...
        <li class="treeview">
            ...
            <ul class="treeview-menu">
                ...
                <li class="active"><a href="/admin/pais"><i class="fa fa-link"></i> <span>Paises</span></a></li>
                <li class="active"><a href="/admin/estados"><i class="fa fa-link"></i> <span>Estados</span></a></li>
            </ul>
        </li>
        <li class="treeview">
